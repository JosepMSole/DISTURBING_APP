...
self.addEventListener('fetch',e=>{
 ...
 if(u.origin===location.origin){
   ...
   const isUiSound=/\/assets\/sounds\/(?:open|openb|back|tap|expand|collapse|confirm|blocked|home)\.mp3$/.test(u.pathname);
   const isCore=e.request.mode==='navigate'||/\/(?:index\.html|app\.js|styles\.css|manifest\.webmanifest|sw\.js|favicon\.ico)$/.test(u.pathname);
   if(isIcon||isStartLayer||isStormAudio||isUiSound){e.respondWith(networkFirst(e.request));return;}
