...
self.addEventListener('fetch',e=>{
 ...
 if(u.origin===location.origin){
   ...
   const isPlayerAudio=/\/assets\/player\/audio\/[^/]+\.mp3$/i.test(u.pathname);
   const isCore=e.request.mode==='navigate'||/\/(?:index\.html|app\.js|styles\.css|manifest\.webmanifest|sw\.js|favicon\.ico)$/.test(u.pathname);
   if(isIcon||isStartLayer||isStormAudio||isUiSound||isTutorialVoice||isPlayerAudio){e.respondWith(networkFirst(e.request));return;}
