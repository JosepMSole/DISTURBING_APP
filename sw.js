// v3.4: el Service Worker nuevo espera al próximo arranque; nunca toma el control a mitad de sesión.
const CACHE='disturbing-pwa-v3.4';
const CORE=['./','./index.html','./styles.css?v=3.4.0','./app.js?v=3.4.0','./manifest.webmanifest','./data/stories.json','./data/books.json','./data/sagas.json','./data/timeline.json','./data/extras.json','./data/player.json','./assets/app-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png','./favicon.ico','https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js','https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js','https://unpkg.com/jsqr@1.4.0/dist/jsQR.js'];
