const CACHE='disturbing-pwa-v1.13';
const CORE=['./','./index.html','./styles.css?v=1.13.0','./app.js?v=1.13.0','./manifest.webmanifest','./data/stories.json','./data/books.json','./assets/app-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png','./favicon.ico'];
