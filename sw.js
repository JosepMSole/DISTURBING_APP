...
self.addEventListener('fetch',e=>{
 ...
 if(u.origin===location.origin){
   ...
   if(isIcon||isStartLayer||isStormAudio){e.respondWith(networkFirst(e.request));return;}
