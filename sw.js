...
self.addEventListener('fetch',e=>{
 ...
 if(u.origin===location.origin){
   ...
   const isUiSound=/\/assets\/sounds\/(?:open|openb|pages|back|tap|expand|collapse|confirm|blocked|home|risa)\.mp3$/.test(u.pathname);
