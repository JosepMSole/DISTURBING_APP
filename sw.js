// v4.1: actualización estable; el Service Worker espera al próximo arranque y no reinicia sesiones activas.
const CACHE='disturbing-pwa-v4.1';
const CORE=['./','./index.html','./styles.css?v=4.1.0','./app.js?v=4.1.0','./manifest.webmanifest','./data/stories.json','./data/books.json','./data/sagas.json','./data/timeline.json','./data/extras.json','./data/player.json','./data/home.json','./data/avatars.json','./supabase-config.js','./assets/app-icon.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png','./favicon.ico','https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js','https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js','https://unpkg.com/jsqr@1.4.0/dist/jsQR.js'];
