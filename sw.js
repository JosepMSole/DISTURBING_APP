// v5.7.0: MICRO logo editable + icon highlight + USER read count + GitHub Importer simplificado; SW estable sin reinicios automáticos.
const CACHE='disturbing-pwa-v5.7.0';
const CORE=['./','./index.html','./styles.css?v=5.7.0','./app.js?v=5.7.0','./manifest.webmanifest','./data/stories.json','./data/books.json','./data/sagas.json','./data/timeline.json','./data/extras.json','./data/player.json','./data/home.json','./data/avatars.json','./data/user.json','./data/micropesadillas.json','./supabase-config.js','./assets/app-icon.png','./assets/start_splatter.png','./assets/start_title.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png','./favicon.ico','https://cdnjs.cloudflare.com/ajax/libs/html5-qrcode/2.3.8/html5-qrcode.min.js','https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.js','https://unpkg.com/jsqr@1.4.0/dist/jsQR.js'];
