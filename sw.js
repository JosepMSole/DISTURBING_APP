...
self.addEventListener('fetch',e=>{
 ...
 if(u.origin===location.origin){
   ...
   const isUiSound=/\/assets\/sounds\/(?:open|back|tap|expand|collapse|confirm|blocked)\.mp3$/.test(u.pathname);
