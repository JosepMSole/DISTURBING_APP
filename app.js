...
const UI_SOUND_FILES={open:'open.mp3',openb:'openb.mp3',pages:'pages.mp3',back:'back.mp3',tap:'tap.mp3',expand:'expand.mp3',collapse:'collapse.mp3',confirm:'confirm.mp3',blocked:'blocked.mp3',home:'home.mp3',risa:'risa.mp3'};
const UI_SOUND_VOLUME={open:.32,openb:.32,pages:.32,back:.32,tap:.24,expand:.28,collapse:.28,confirm:.34,blocked:.31,home:.34,risa:.40};
...
async function registerSW(){if('serviceWorker'in navigator){try{const reg=await navigator.serviceWorker.register('./sw.js?v=6.7.0',{updateViaCache:'none'});try{await reg.update()}catch{} }catch(e){console.warn('SW',e)}}}
boot();
